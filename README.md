# [ATM7-1.0.3](https://www.curseforge.com/minecraft/modpacks/all-the-mods-7) on Curseforge
...
The docker on first run will download the same version as tagged of `ATM7-1.0.3` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "ATM7-1.0.3 Server Powered by Docker"
* LEVEL world
